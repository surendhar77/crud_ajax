        ...
        <table class="table table-bordered data-table">
            ...
            <tbody id="contact">
                ...
                <tr>
                    ...
                    <td><?php if($contact->country==0): ?>
                        India
                        <?php elseif($contact->country==1): ?>
                        Srilanka
                        <?php elseif($contact->country==2): ?>
                        Bangaladesh
                        <?php else: ?>
                        Pakisthan
                        <?php endif; ?>
                    ...
                    <td>
                        <a href="#" class="btn btn-primary edit" data-id="<?php echo e($contact->id); ?>" data-name="<?php echo e($contact->name); ?>" data-number="<?php echo e($contact->phone_number); ?>" data-email="<?php echo e($contact->email); ?>" data-gender="<?php echo e($contact->gender); ?>" data-country="<?php echo e($contact->country); ?>" data-address="<?php echo e($contact->address); ?>">Edit</a>
                        <a href="#" class="btn btn-danger delete" data-id="<?php echo e($contact->id); ?>">Delete</a>
                    </td>
                </tr>
    ...
    $(document).ready(function() {
        $('#createNewcontact').click(function(e) {
            ...
            $('#add').click(function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('contact.add')); ?>",
                    data: formData,
                    type: "POST",
                    processData: false,
                    contentType: false,
        ...
        $('#update').click(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('contact.update', '')); ?>/" + id,
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
        ...
        $('.deletecontact').click(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('contact.delete', '')); ?>/" + id,
                data: id,
                method: "DELETE",
                success: function(response) {
...
</html><?php /**PATH C:\xampp\htdocs\crud_ajax\resources\views/contact.blade.php ENDPATH**/ ?>